...
This project is a fork of the original [node-express-mongodb-jwt-rest-api-skeleton](https://github.com/Ciriak/node-typescript-mongodb-rest-api-skeleton) Version **v7.1.2** created by **Daniel Avellaneda**
